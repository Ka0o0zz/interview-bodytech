...
import homeImage from "../../assets/images/person.jpg";
import "./style.css";
...
export default function Login() {
  ...
  const [, setSpotifyTokenResponse] = useRecoilState(spotifyTokenResponseAtom);
  ...
  }, [history, setIsAuthenticated, setSpotifyRefreshToken, setSpotifyTokenResponse, spotifyRefreshToken]);
  ...
  }, [authenticateUser, isAuthenticated, location.search]);
  ...
  return (
    <div className="home-container">
      <div className="home-left-child">
        <h3>Welcome</h3>
        <h6>Login to enjoy the best songs of the moment</h6>
